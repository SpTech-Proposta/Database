...
INSERT INTO Container (origem, destino, dtSaida, dtChegada,tipo_carga, distancia, status_carga) VALUES
('Porto de Santos', 'Porto de Paranaguá', '2026-03-01 14:14:00', '2026-03-03 14:11:00', 'Carne', 450.50, 'Finalizado'),
('Porto de Salvador', 'Porto de Suape', '2026-03-02', '2026-4-20', 'Frango', 680.00, 'Em andamento'),
('Porto de Itajaí', 'Porto de Rio Grande', '2026-03-03', NULL, 'Peixe', 520.30, 'Em trafego'),
('Porto de Vitória', 'Porto de Santos', '2026-03-04', NULL, 'Carne', 510.00, 'Descarregando');
...
=======
	...
	RENAME TABLE Usuario_empresa TO Cliente_da_Empresa;
>>>>>>> f9eb53b0415f33ab1123f8962185944cda22e85f
